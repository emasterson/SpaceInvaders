...
namespace SpaceInvaders
{
    class CollisionSprite : BaseSprite
    {
        public CollisionSprite()
            :base()
        {
            this.name = CollisionSpriteNames.Not_Initialized;
            this.index = Index.i0;
            this.lineWidth = 1.0f;
        ...
        public CollisionSprite(CollisionSpriteNames _name, Index _n)
            : base()
        {
            this.name = _name;
            this.index = _n;
        ...
        public void Set(CollisionSpriteNames collisionSpriteName, Index _index, Azul.Color color, int x, int y, int width, int height)
        {
        ...
        public void Set(CollisionSpriteNames collisionSpriteName, Index _index, Azul.Color color, CollisionRect rect)
        {
            this.name = collisionSpriteName;
            this.index = _index;
            this.lineWidth = 2.0f;
        ...
        // Data------------------------------------
        public CollisionSpriteNames name;
        public Index index;
